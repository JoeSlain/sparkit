...
2. From the repository root run `pnpm --filter @agency/db generate`.
3. Review generated SQL, especially constraints, drops and RLS changes.
4. Run `pnpm --filter @agency/db export`. It creates immutable SQL copies in `supabase/migrations/`; `check` detects missing or modified exports.
